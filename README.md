...
During the actual competition, your game will receive controller inputs directly from the
real controller device via a Bluetooth connection.

The supplied controller.c/controller.h in the controller_sample folder will work with
either case, allowing you to create a single binary that should work under all situations.
...
It is assumed that you have successfully booted the Sandpiper emulator, and built/run
some of the SDK sample applications.
